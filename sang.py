...
def sang() : 
    while True:
        try:
            time.sleep(0.01)
            profit_one = mt5.positions_get( ticket =  5122332990)[0].profit + mt5.positions_get( ticket =  5122332991)[0].profit + mt5.positions_get( ticket =  5122332989)[0].profit
            profit_tow = mt5.positions_get( ticket =  5122332994)[0].profit + mt5.positions_get( ticket =  5122332995)[0].profit + mt5.positions_get( ticket =  5122332992)[0].profit
